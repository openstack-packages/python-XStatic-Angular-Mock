...
Version:        XXX
Release:        1%{?dist}
Summary:        Angular-Mock JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-angular-mock/
...
%description
Angular-Mock javascript library packaged for
...
%files
%doc README.txt
%{python_sitelib}/XStatic_Angular_Mock-%{version}-py?.?.egg-info
%{python_sitelib}/XStatic_Angular_Mock-%{version}-py?.?-nspkg.pth
%{python_sitelib}/xstatic/pkg/angular_mock
